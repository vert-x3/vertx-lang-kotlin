...
----
include::{sourcedir}/Example.kt[tags=launchCoroutine]
----
...
[source,kotlin,indent=0]
----
include::{sourcedir}/Example.kt[tags=CoroutineVerticle]
----
...
[source,kotlin,indent=0]
----
include::{sourcedir}/Example.kt[tags=awaitResult]
----
...
[source,kotlin,indent=0]
----
include::{sourcedir}/Example.kt[tags=awaitResultFailure]
----
...
[source,kotlin,indent=0]
----
include::{sourcedir}/Example.kt[tags=awaitEvent]
----
...
[source,kotlin,indent=0]
----
include::{sourcedir}/Example.kt[tags=awaitBlocking]
----
...
[source,kotlin,indent=0]
----
include::{sourcedir}/Example.kt[tags=streamExample]
----
...
[source,kotlin,indent=0]
----
include::{sourcedir}/Example.kt[tags=awaitingFuture]
----
...
[source,kotlin,indent=0]
----
include::{sourcedir}/Example.kt[tags=channel0]
----
...
[source,kotlin,indent=0]
----
include::{sourcedir}/Example.kt[tags=channel1]
----
...
[source,kotlin,indent=0]
----
include::{sourcedir}/Example.kt[tags=channel2]
----
...
[source,kotlin,indent=0]
----
include::{sourcedir}/Example.kt[tags=channel3]
----
...
[source,kotlin,indent=0]
----
include::{sourcedir}/Example.kt[tags=sendChannel]
----
...
[source,kotlin,indent=0]
----
include::{sourcedir}/Example.kt[tags=delay]
----
...
[source,kotlin,indent=0]
----
include::{sourcedir}/Example.kt[tags=cancellation]
----
...
[source,kotlin,indent=0]
----
include::{sourcedir}/Example.kt[tags=withTimeout]
----
