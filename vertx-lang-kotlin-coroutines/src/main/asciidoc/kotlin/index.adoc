...
----
include::../../kotlin/examples/Example.kt[tags=launchCoroutineExample]
----
...
[source,kotlin,indent=0]
----
include::../../kotlin/examples/Example.kt[tags=CoroutineVerticle]
----
...
[source,kotlin,indent=0]
----
include::../../kotlin/examples/Example.kt[tags=awaitResult]
----
...
[source,kotlin,indent=0]
----
include::../../kotlin/examples/Example.kt[tags=awaitResultFailure]
----
...
[source,kotlin,indent=0]
----
include::../../kotlin/examples/Example.kt[tags=awaitEvent]
----
...
[source,kotlin,indent=0]
----
include::../../kotlin/examples/Example.kt[tags=streamExample]
----
...
[source,kotlin,indent=0]
----
include::../../kotlin/examples/Example.kt[tags=handlerAndCoroutine]
----
...
[source,kotlin,indent=0]
----
include::../../kotlin/examples/Example.kt[tags=awaitingFuture]
----
...
[source,kotlin,indent=0]
----
include::../../kotlin/examples/Example.kt[tags=channel0]
----
...
[source,kotlin,indent=0]
----
include::../../kotlin/examples/Example.kt[tags=channel1]
----
...
[source,kotlin,indent=0]
----
include::../../kotlin/examples/Example.kt[tags=channel2]
----
...
[source,kotlin,indent=0]
----
include::../../kotlin/examples/Example.kt[tags=channel3]
----
...
[source,kotlin,indent=0]
----
include::../../kotlin/examples/Example.kt[tags=sendChannel]
----
...
[source,kotlin,indent=0]
----
include::../../kotlin/examples/Example.kt[tags=broadcastTemperature]
----
