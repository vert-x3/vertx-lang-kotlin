...
suspend fun ConsulClient.deleteValueAwait(key : String) : Void {
    return awaitResult{
        this.deleteValue(key, it)
    }
}
...
suspend fun ConsulClient.deleteValuesAwait(keyPrefix : String) : Void {
    return awaitResult{
        this.deleteValues(keyPrefix, it)
    }
}
...
suspend fun ConsulClient.destroyAclTokenAwait(id : String) : Void {
    return awaitResult{
        this.destroyAclToken(id, it)
    }
}
...
suspend fun ConsulClient.registerServiceAwait(serviceOptions : ServiceOptions) : Void {
    return awaitResult{
        this.registerService(serviceOptions, it)
    }
}

suspend fun ConsulClient.maintenanceServiceAwait(maintenanceOptions : MaintenanceOptions) : Void {
    return awaitResult{
        this.maintenanceService(maintenanceOptions, it)
    }
}

suspend fun ConsulClient.deregisterServiceAwait(id : String) : Void {
    return awaitResult{
        this.deregisterService(id, it)
    }
}
...
suspend fun ConsulClient.registerCheckAwait(checkOptions : CheckOptions) : Void {
    return awaitResult{
        this.registerCheck(checkOptions, it)
    }
}

suspend fun ConsulClient.deregisterCheckAwait(checkId : String) : Void {
    return awaitResult{
        this.deregisterCheck(checkId, it)
    }
}

suspend fun ConsulClient.passCheckAwait(checkId : String) : Void {
    return awaitResult{
        this.passCheck(checkId, it)
    }
}

suspend fun ConsulClient.passCheckWithNoteAwait(checkId : String, note : String) : Void {
    return awaitResult{
        this.passCheckWithNote(checkId, note, it)
    }
}

suspend fun ConsulClient.warnCheckAwait(checkId : String) : Void {
    return awaitResult{
        this.warnCheck(checkId, it)
    }
}

suspend fun ConsulClient.warnCheckWithNoteAwait(checkId : String, note : String) : Void {
    return awaitResult{
        this.warnCheckWithNote(checkId, note, it)
    }
}

suspend fun ConsulClient.failCheckAwait(checkId : String) : Void {
    return awaitResult{
        this.failCheck(checkId, it)
    }
}

suspend fun ConsulClient.failCheckWithNoteAwait(checkId : String, note : String) : Void {
    return awaitResult{
        this.failCheckWithNote(checkId, note, it)
    }
}

suspend fun ConsulClient.updateCheckAwait(checkId : String, status : CheckStatus) : Void {
    return awaitResult{
        this.updateCheck(checkId, status, it)
    }
}

suspend fun ConsulClient.updateCheckWithNoteAwait(checkId : String, status : CheckStatus, note : String) : Void {
    return awaitResult{
        this.updateCheckWithNote(checkId, status, note, it)
    }
}
...
suspend fun ConsulClient.destroySessionAwait(id : String) : Void {
    return awaitResult{
        this.destroySession(id, it)
    }
}
...
suspend fun ConsulClient.updatePreparedQueryAwait(definition : PreparedQueryDefinition) : Void {
    return awaitResult{
        this.updatePreparedQuery(definition, it)
    }
}

suspend fun ConsulClient.deletePreparedQueryAwait(id : String) : Void {
    return awaitResult{
        this.deletePreparedQuery(id, it)
    }
}
