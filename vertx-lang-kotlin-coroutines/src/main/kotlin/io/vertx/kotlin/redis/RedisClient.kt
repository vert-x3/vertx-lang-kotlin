...
suspend fun RedisClient.clusterAddslotsAwait(slots : List<Long>) : Void {
    return awaitResult{
...
suspend fun RedisClient.clusterDelslotsAwait(slot : Long) : Void {
    return awaitResult{
        this.clusterDelslots(slot, it)
    }
}

suspend fun RedisClient.clusterDelslotsManyAwait(slots : List<Long>) : Void {
    return awaitResult{
        this.clusterDelslotsMany(slots, it)
    }
}

suspend fun RedisClient.clusterFailoverAwait() : Void {
    return awaitResult{
        this.clusterFailover(it)
    }
}

suspend fun RedisClient.clusterFailOverWithOptionsAwait(options : FailoverOptions) : Void {
    return awaitResult{
        this.clusterFailOverWithOptions(options, it)
    }
}

suspend fun RedisClient.clusterForgetAwait(nodeId : String) : Void {
    return awaitResult{
...
suspend fun RedisClient.clusterMeetAwait(ip : String, port : Long) : Void {
    return awaitResult{
...
suspend fun RedisClient.clusterReplicateAwait(nodeId : String) : Void {
    return awaitResult{
        this.clusterReplicate(nodeId, it)
    }
}

suspend fun RedisClient.clusterResetAwait() : Void {
    return awaitResult{
        this.clusterReset(it)
    }
}

suspend fun RedisClient.clusterResetWithOptionsAwait(options : ResetOptions) : Void {
    return awaitResult{
        this.clusterResetWithOptions(options, it)
    }
}

suspend fun RedisClient.clusterSaveconfigAwait() : Void {
    return awaitResult{
        this.clusterSaveconfig(it)
    }
}

suspend fun RedisClient.clusterSetConfigEpochAwait(epoch : Long) : Void {
    return awaitResult{
        this.clusterSetConfigEpoch(epoch, it)
    }
}

suspend fun RedisClient.clusterSetslotAwait(slot : Long, subcommand : SlotCmd) : Void {
    return awaitResult{
        this.clusterSetslot(slot, subcommand, it)
    }
}

suspend fun RedisClient.clusterSetslotWithNodeAwait(slot : Long, subcommand : SlotCmd, nodeId : String) : Void {
    return awaitResult{
...
suspend fun RedisClient.monitorAwait() : Void {
    return awaitResult{
        this.monitor(it)
    }
}
...
suspend fun RedisClient.objectAwait(key : String, cmd : ObjectCmd) : Void {
    return awaitResult{
...
suspend fun RedisClient.psetexAwait(key : String, millis : Long, value : String) : Void {
    return awaitResult{
...
suspend fun RedisClient.punsubscribeAwait(patterns : List<String>) : Void {
    return awaitResult{
...
suspend fun RedisClient.setAwait(key : String, value : String) : Void {
    return awaitResult{
...
suspend fun RedisClient.setBinaryAwait(key : String, value : Buffer) : Void {
    return awaitResult{
        this.setBinary(key, value, it)
    }
}

suspend fun RedisClient.setBinaryWithOptionsAwait(key : String, value : Buffer, options : SetOptions) : Void {
    return awaitResult{
...
suspend fun RedisClient.slowlogResetAwait() : Void {
    return awaitResult{
...
suspend fun RedisClient.syncAwait() : Void {
    return awaitResult{
        this.sync(it)
    }
}
...
suspend fun RedisClient.unsubscribeAwait(channels : List<String>) : Void {
    return awaitResult{
