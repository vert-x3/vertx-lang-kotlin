...
image:https://img.shields.io/badge/kotlin-1.7.0-blue.svg["Kotlin version badge",link="https://kotlinlang.org"]
image:https://img.shields.io/badge/kotlinx.coroutines-1.6.2-blue.svg["Coroutines version badge",link="https://github.com/Kotlin/kotlinx.coroutines#kotlinxcoroutines"]
...
Extensions need to be tested and link:vertx-lang-kotlin/src/main/asciidoc/vertx-core/kotlin/index.adoc[documented].
...
Kotlin evolves fast, so just change the project versions, test it, and shoot a PR.
