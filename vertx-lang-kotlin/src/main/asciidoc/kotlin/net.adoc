...
var options = io.vertx.core.net.NetClientOptions(
...
var options = io.vertx.core.net.NetServerOptions(
  ssl = true,
  pfxKeyCertOptions = io.vertx.core.net.PfxOptions(
...
var pfxOptions = io.vertx.core.net.PfxOptions(
  value = myKeyStoreAsABuffer,
  password = "password-of-your-keystore")
var options = io.vertx.core.net.NetServerOptions(
  ssl = true,
...
var pemOptions = io.vertx.core.net.PemKeyCertOptions(
...
var options = io.vertx.core.net.NetServerOptions(
  ssl = true,
  clientAuth = "REQUIRED",
  pfxTrustOptions = io.vertx.core.net.PfxOptions(
...
var options = io.vertx.core.net.NetServerOptions(
  ssl = true,
  clientAuth = "REQUIRED",
  pemTrustOptions = io.vertx.core.net.PemTrustOptions(
...
options = io.vertx.core.net.NetServerOptions(
  ssl = true,
  keyStoreOptions = keyStoreOptions,
