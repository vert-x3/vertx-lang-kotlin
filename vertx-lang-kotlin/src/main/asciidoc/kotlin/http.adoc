...
var options = io.vertx.core.http.HttpServerOptions(
...
var clientOptions = io.vertx.core.http.HttpClientOptions(
...
connection.updateSettings(io.vertx.core.http.Http2Settings(
...
[source,kotlin]
----
import io.vertx.kotlin.core.http.WebSocketFrame
import io.vertx.lang.kotlin.*
