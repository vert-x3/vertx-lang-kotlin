...
var vertx = Vertx.vertx(io.vertx.core.VertxOptions(
  workerPoolSize = 40))
...
var someAPI = examples.CoreExamples.BlockingAPI()
...
----
import io.vertx.kotlin.common.json.*
import io.vertx.kotlin.core.CompositeFuture
import io.vertx.kotlin.core.Future
...
var options = io.vertx.core.DeploymentOptions(
  worker = true)
...
----
import io.vertx.kotlin.common.json.*
import io.vertx.kotlin.core.Context
...
vertx.deployVerticle("the-verticle", io.vertx.core.DeploymentOptions(
...
var vertx = Vertx.vertx(io.vertx.core.VertxOptions(
  addressResolverOptions = io.vertx.core.dns.AddressResolverOptions(
