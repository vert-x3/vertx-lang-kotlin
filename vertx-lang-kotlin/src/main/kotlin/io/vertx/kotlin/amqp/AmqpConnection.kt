 ...
 * NOTE: This function has been automatically generated from [io.vertx.amqp.AmqpConnection] using Vert.x codegen.
 */
@Deprecated(message = "Instead use createReceiver returning a future that can yield a result ", replaceWith = ReplaceWith("createReceiver(address).await()"))
 ...
 * NOTE: This function has been automatically generated from [io.vertx.amqp.AmqpConnection] using Vert.x codegen.
 */
@Deprecated(message = "Instead use createReceiver returning a future that can yield a result ", replaceWith = ReplaceWith("createReceiver(address, receiverOptions).await()"))
 ...
 * NOTE: This function has been automatically generated from [io.vertx.amqp.AmqpConnection] using Vert.x codegen.
 */
@Deprecated(message = "Instead use createDynamicReceiver returning a future that can yield a result ", replaceWith = ReplaceWith("createDynamicReceiver().await()"))
 ...
 * NOTE: This function has been automatically generated from [io.vertx.amqp.AmqpConnection] using Vert.x codegen.
 */
@Deprecated(message = "Instead use createSender returning a future that can yield a result ", replaceWith = ReplaceWith("createSender(address).await()"))
 ...
 * NOTE: This function has been automatically generated from [io.vertx.amqp.AmqpConnection] using Vert.x codegen.
 */
@Deprecated(message = "Instead use createSender returning a future that can yield a result ", replaceWith = ReplaceWith("createSender(address, options).await()"))
 ...
 * NOTE: This function has been automatically generated from [io.vertx.amqp.AmqpConnection] using Vert.x codegen.
 */
@Deprecated(message = "Instead use createAnonymousSender returning a future that can yield a result ", replaceWith = ReplaceWith("createAnonymousSender().await()"))
