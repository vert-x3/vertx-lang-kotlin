 ...
 */
@Deprecated(message = "Instead use getUserCredentialsByName returning a future that can yield a result ", replaceWith = ReplaceWith("getUserCredentialsByName(username).await()"))
 ...
 * NOTE: This function has been automatically generated from [io.vertx.ext.auth.webauthn.CredentialStore] using Vert.x codegen.
 */
@Deprecated(message = "Instead use getUserCredentialsById returning a future that can yield a result ", replaceWith = ReplaceWith("getUserCredentialsById(rawId).await()"))
 ...
 * NOTE: This function has been automatically generated from [io.vertx.ext.auth.webauthn.CredentialStore] using Vert.x codegen.
 */
@Deprecated(message = "Instead use updateUserCredential returning a future that can yield a result ", replaceWith = ReplaceWith("updateUserCredential(id, data, upsert).await()"))
