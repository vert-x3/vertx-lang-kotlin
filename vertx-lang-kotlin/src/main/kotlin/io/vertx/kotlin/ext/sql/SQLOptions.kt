...
@Deprecated(
  ...
  replaceWith = ReplaceWith("sqlOptionsOf(autoGeneratedKeys, autoGeneratedKeysIndexes, catalog, fetchDirection, fetchSize, queryTimeout, readOnly, resultSetConcurrency, resultSetType, schema, transactionIsolation)")
)
fun SQLOptions(
  autoGeneratedKeys: Boolean? = null,
  autoGeneratedKeysIndexes: io.vertx.core.json.JsonArray? = null,
