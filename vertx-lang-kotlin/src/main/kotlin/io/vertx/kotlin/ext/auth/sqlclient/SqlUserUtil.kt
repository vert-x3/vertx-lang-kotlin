...
/**
 * Suspending version of method [io.vertx.ext.auth.sqlclient.SqlUserUtil.createUser]
 *
...
/**
 * Suspending version of method [io.vertx.ext.auth.sqlclient.SqlUserUtil.createHashedUser]
 *
 * @param username the username to be set
...
/**
 * Suspending version of method [io.vertx.ext.auth.sqlclient.SqlUserUtil.createUserRole]
 *
 * @param username the username to be set
...
/**
 * Suspending version of method [io.vertx.ext.auth.sqlclient.SqlUserUtil.createRolePermission]
 *
 * @param role a to be set
