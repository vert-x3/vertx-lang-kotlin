 ...
 */
@Deprecated(message = "Instead use onAuthenticationRequest returning a future that can yield a result ", replaceWith = ReplaceWith("onAuthenticationRequest(connection, login, passcode).await()"))
