...
@Deprecated(
  ...
  replaceWith = ReplaceWith("mongoAuthenticationOptionsOf(collectionName, passwordCredentialField, passwordField, usernameCredentialField, usernameField)")
)
fun MongoAuthenticationOptions(
  collectionName: String? = null,
  passwordCredentialField: String? = null,
  passwordField: String? = null,
  usernameCredentialField: String? = null,
