 ...
 *
 * @param alternate  Optional. Field that determines whether collation should consider whitespace and punctuation as base characters for purposes of comparison. <p> Possible values are: "non-ignorable" Whitespace and punctuation are considered base characters. "shifted" Whitespace and punctuation are not considered base characters and are only distinguished at strength levels greater than 3. See <a href="http://userguide.icu-project.org/collation/concepts#TOC-Comparison-Levels">ICU Collation: Comparison Levels</a> for more information. <p> Default is "non-ignorable".
 ...
 * @param caseFirst  Optional. A field that determines sort order of case differences during tertiary level comparisons. <p> Possible values are: "upper" Uppercase sorts before lowercase. "lower" Lowercase sorts before uppercase. "off"   Default value. Similar to "lower" with slight differences. See <a href="http://userguide.icu-project.org/collation/customization">Collation customization</a> for details of differences.
 ...
 * @param locale  The ICU locale. See <a href="https://docs.mongodb.com/manual/reference/collation-locales-defaults/#std-label-collation-languages-locales">Supported Languages and Locales</a> for a list of supported locales. <p> To specify simple binary comparison, specify locale value of "simple".
 * @param maxVariable  Optional. Field that determines up to which characters are considered ignorable when alternate: "shifted". Has no effect if alternate: "non-ignorable" <p> Possible values are: "punct" Both whitespace and punctuation are "ignorable", i.e. not considered base characters. "space" Whitespace are "ignorable", i.e. not considered base characters.
...
fun collationOptionsOf(
  ...
  caseFirst: CaseFirst? = null,
  caseLevel: Boolean? = null,
  locale: String? = null,
  maxVariable: MaxVariable? = null,
  ...
  if (maxVariable != null) {
    this.setMaxVariable(maxVariable)
  }
