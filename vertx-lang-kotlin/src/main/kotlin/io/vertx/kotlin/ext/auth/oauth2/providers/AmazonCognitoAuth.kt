...
import io.vertx.ext.auth.oauth2.providers.AmazonCognitoAuth as AmazonCognitoAuthVertxAlias
import io.vertx.kotlin.coroutines.awaitResult

object AmazonCognitoAuth {
  /**
   * Suspending version of method [io.vertx.ext.auth.oauth2.providers.AmazonCognitoAuth.discover]
   *
   ...
   */
  @Deprecated(message = "Instead use discover returning a future that can yield a result ", replaceWith = ReplaceWith("discover(vertx, config).await()"))
