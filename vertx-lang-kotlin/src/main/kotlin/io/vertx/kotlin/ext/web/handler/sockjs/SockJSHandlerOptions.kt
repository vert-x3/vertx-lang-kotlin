...
@Deprecated(
  ...
  replaceWith = ReplaceWith("sockJSHandlerOptionsOf(disabledTransports, heartbeatInterval, insertJSESSIONID, libraryURL, localWriteHandler, maxBytesStreaming, registerWriteHandler, sessionTimeout)")
)
