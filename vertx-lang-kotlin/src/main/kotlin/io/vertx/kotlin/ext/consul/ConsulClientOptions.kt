 ...
 * @param decompressionSupported  Set whether compression is enabled
...
fun consulClientOptionsOf(
  ...
  dc: String? = null,
  timeout: Long? = null,
  keyCertOptions: io.vertx.core.net.KeyCertOptions? = null): ConsulClientOptions = io.vertx.ext.consul.ConsulClientOptions().apply {
