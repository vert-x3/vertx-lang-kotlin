 ...
 */
@Deprecated(message = "Instead use replyAndRequest returning a future that can yield a result ", replaceWith = ReplaceWith("replyAndRequest(message).await()"))
 ...
 * NOTE: This function has been automatically generated from [io.vertx.core.eventbus.Message] using Vert.x codegen.
 */
@Deprecated(message = "Instead use replyAndRequest returning a future that can yield a result ", replaceWith = ReplaceWith("replyAndRequest(message, options).await()"))
