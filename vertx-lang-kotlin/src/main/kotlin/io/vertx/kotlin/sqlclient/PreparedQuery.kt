 ...
 * NOTE: This function has been automatically generated from [io.vertx.sqlclient.PreparedQuery] using Vert.x codegen.
 */
@Deprecated(message = "Instead use execute returning a future that can yield a result ", replaceWith = ReplaceWith("execute(tuple).await()"))
 ...
 * NOTE: This function has been automatically generated from [io.vertx.sqlclient.PreparedQuery] using Vert.x codegen.
 */
@Deprecated(message = "Instead use executeBatch returning a future that can yield a result ", replaceWith = ReplaceWith("executeBatch(batch).await()"))
