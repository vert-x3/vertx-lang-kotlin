...
object HttpEndpoint {
   ...
   */
  @Deprecated(message = "Instead use getClient returning a future that can yield a result ", replaceWith = ReplaceWith("getClient(discovery, filter).await()"))
   ...
   * NOTE: This function has been automatically generated from [io.vertx.servicediscovery.types.HttpEndpoint] using Vert.x codegen.
   */
  @Deprecated(message = "Instead use getWebClient returning a future that can yield a result ", replaceWith = ReplaceWith("getWebClient(discovery, filter).await()"))
   ...
   * NOTE: This function has been automatically generated from [io.vertx.servicediscovery.types.HttpEndpoint] using Vert.x codegen.
   */
  @Deprecated(message = "Instead use getClient returning a future that can yield a result ", replaceWith = ReplaceWith("getClient(discovery, filter, conf).await()"))
   ...
   * NOTE: This function has been automatically generated from [io.vertx.servicediscovery.types.HttpEndpoint] using Vert.x codegen.
   */
  @Deprecated(message = "Instead use getWebClient returning a future that can yield a result ", replaceWith = ReplaceWith("getWebClient(discovery, filter, conf).await()"))
