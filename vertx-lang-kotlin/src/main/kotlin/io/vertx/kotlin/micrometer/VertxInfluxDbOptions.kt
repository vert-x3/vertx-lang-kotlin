...
@Deprecated(
  ...
  replaceWith = ReplaceWith("vertxInfluxDbOptionsOf(batchSize, compressed, connectTimeout, db, enabled, numThreads, password, readTimeout, retentionPolicy, step, uri, userName)")
)
