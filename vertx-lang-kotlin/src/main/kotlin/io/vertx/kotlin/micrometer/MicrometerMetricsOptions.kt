...
@Deprecated(
  ...
  replaceWith = ReplaceWith("micrometerMetricsOptionsOf(disabledMetricsCategories, enabled, influxDbOptions, jmxMetricsOptions, jvmMetricsEnabled, labelMatches, labelMatchs, labels, prometheusOptions, registryName)")
)
