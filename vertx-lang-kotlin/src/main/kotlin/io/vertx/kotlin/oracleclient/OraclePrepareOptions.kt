...
fun oraclePrepareOptionsOf(
  autoGeneratedKeys: Boolean? = null,
  autoGeneratedKeysIndexes: io.vertx.core.json.JsonArray? = null): OraclePrepareOptions = io.vertx.oracleclient.OraclePrepareOptions().apply {
