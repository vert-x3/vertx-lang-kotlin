...
@Deprecated(
  ...
  replaceWith = ReplaceWith("jdbcConnectOptionsOf(connectTimeout, dataSourceImplementation, database, idleTimeout, jdbcUrl, metricsEnabled, password, user)")
)
fun JDBCConnectOptions(
  connectTimeout: Int? = null,
  dataSourceImplementation: String? = null,
  database: String? = null,
  idleTimeout: Int? = null,
